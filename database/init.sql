...
CREATE TABLE dishes (
    ...
    dish_type ENUM('single', 'combo') DEFAULT 'single' COMMENT '菜品类型',
...
CREATE TABLE order_items (
    ...
    item_type ENUM('single', 'combo') DEFAULT 'single' COMMENT '订单项类型',
...
CREATE TABLE coupons (
    ...
    type ENUM('discount', 'deduction') NOT NULL COMMENT '类型:折扣/减免',
    discount DECIMAL(10,2) COMMENT '折扣金额或比例',
...
('test_openid_001', '测试学生', 'https://example.com/avatar1.jpg', '13800138001', 'student'),
('test_openid_002', '测试管理员', 'https://example.com/avatar2.jpg', '13800138002', 'admin');

INSERT INTO merchants (name, logo, description, address, latitude, longitude, phone, business_hours, status, month_sales, rating) VALUES
('美味食堂', 'https://example.com/merchant1.jpg', '学校第一食堂，物美价廉', '校园内第一食堂', 23.123456, 113.123456, '020-12345678', '07:00-20:00', 'open', 1500, 4.8),
('快乐餐厅', 'https://example.com/merchant2.jpg', '各种美食应有尽有', '校园内第二食堂', 23.123789, 113.123789, '020-87654321', '08:00-21:00', 'open', 2000, 4.9);
...
INSERT INTO dishes (merchant_id, category_id, name, description, image, price, stock, sales, status) VALUES
(1, 1, '宫保鸡丁', '经典川菜，香辣可口', 'https://example.com/dish1.jpg', 15.00, 100, 50, 'available'),
(1, 1, '鱼香肉丝', '酸甜可口，下饭首选', 'https://example.com/dish2.jpg', 14.00, 100, 45, 'available'),
(1, 2, '煎饺', '外酥里嫩，一份8个', 'https://example.com/dish3.jpg', 8.00, 50, 30, 'available'),
(2, 3, '红烧肉盖饭', '肥而不腻，香气扑鼻', 'https://example.com/dish4.jpg', 18.00, 80, 60, 'available'),
(2, 4, '牛肉拉面', '汤鲜肉嫩，面条劲道', 'https://example.com/dish5.jpg', 16.00, 60, 40, 'available');

INSERT INTO riders (openid, name, phone, avatar, status) VALUES
('rider_openid_001', '张三', '13900139001', 'https://example.com/rider1.jpg', 'online'),
('rider_openid_002', '李四', '13900139002', 'https://example.com/rider2.jpg', 'online');

INSERT INTO addresses (user_id, name, phone, address, building, room, latitude, longitude, is_default) VALUES
(1, '张同学', '13800138001', '校园内学生宿舍', '1号楼', '101', 23.124000, 113.124000, TRUE);
